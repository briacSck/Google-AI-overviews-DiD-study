...
Staggered difference-in-differences analysis of the impact of Google's AI Overviews on website traffic. With data from the European Commission.
...
- 
otebooks/: Exploratory analysis and sanity-check notebooks.
- 	ests/: Minimal tests for key transformations and estimators.
- docs/: Design notes, methodological choices, and replication instructions.

## Stack

Primarily Python (with DiD libraries) and/or R (e.g. did, ixest) for staggered DiD estimation.
